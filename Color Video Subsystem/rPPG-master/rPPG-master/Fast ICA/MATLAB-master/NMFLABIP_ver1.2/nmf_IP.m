...
function [A,X,Distance_output]=nmf_IP(Y,r,Index_norm, A_true, S, mc_on, NoAlts,restart_mc_on,AL,Y_true,type_alg_A, type_alg_X, max_restart, no_iter, reg_oper_A, reg_oper_X, reg_param_A, reg_param_X, weightA, weightX, alphaA0, alphaX0, tauA, tauX, alphaA_reg_const, alphaX_reg_const, alphaA, alphaX )
%
...
if (type_alg_A == 6) & (size(A_true,1) ~= size(Y,1))
