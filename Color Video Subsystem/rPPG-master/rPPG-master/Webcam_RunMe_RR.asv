...
%% Flags 
visualization_flag=1; % Visualize EVERY STEP for us 
%% set parameters
...
t_start=tic;
image_struct=Take_Internal_Webcam_Images(num_frames); % take images
t_take_img=toc(t_start);
[DetectedFaceStruct,DetectedChestStruct,detail_struct]=GetFaceandChestROI(image_struct,faceDetector,pointTracker_Face,pointTracker_Chest,KLT_conf,Refresh_ROI_Frames);
