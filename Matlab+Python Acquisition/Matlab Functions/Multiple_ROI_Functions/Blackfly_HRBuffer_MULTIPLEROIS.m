function output_struct=Blackfly_HRBuffer_MULTIPLEROIS(Refresh_struct)
...
% making figure here
figure
nrows=length(Refresh_struct.BBox);
ncols=3;
...
for i=1:rc % 1 to refresh cycle
    ...
    for rr=1:nrows % box
        ...
        if i==1
            subplot(nrows,ncols,plt_idx1);p{plt_idx1}=imagesc(Last_Image{rr});colorbar;title("last frame");
